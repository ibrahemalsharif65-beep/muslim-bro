...
تعليمات صارمة جداً:
- يجب أن تكتب ردودك باللغة العربية فقط بدون استثناء.
- ممنوع منعاً باتاً استخدام أي لغة أخرى كالإنجليزية أو الصينية أو اليابانية أو غيرها.
- إذا كان السؤال بغير العربية، أجب بالعربية فقط.
